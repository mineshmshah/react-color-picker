...
var hueSliderReducer = _defineProperty$1({}, hueSliderTypes.UPDATE_HUE_POSITION, function (state, _ref) {
  ...
  var newPosition = value * areaWidth / 360 | 0;
  return _objectSpread$1({}, state, {
...
var hueSliderVerticalReducer = _defineProperty$1({}, hueSliderTypesVertical.UPDATE_HUE_POSITION_VERTICAL, function (state, _ref) {
  var value = _ref.value,
      areaHeight = _ref.areaHeight;
  var newPosition = value * areaHeight / 360 | 0;
  return _objectSpread$1({}, state, {
    position: newPosition
  });
});
...
var store$1 = reactRedux.connect(mapStateToProps, mapDispatchToProps);
...
var PickerArea$1 = store$1(PickerArea);
...
var store$2 = reactRedux.connect(mapStateToProps$1, mapDispatchToProps$1);
...
var RGBAInput = store$2(RGBComponent);
...
var store$3 = reactRedux.connect(mapStateToProps$2, mapDispatchToProps$2);
...
var store$4 = reactRedux.connect(mapStateToProps$3, mapDispatchToProps$3);
...
var HueSliderVertical$1 = store$4(HueSliderVertical);
...
var store$5 = reactRedux.connect(mapStateToProps$4, mapDispatchToProps$4);
...
var AlphaSliderVertical = store$5(AlphaSlider);
...
var store$6 = reactRedux.connect(mapStateToProps$5, mapDispatchToProps$5);
...
var store$7 = reactRedux.connect(mapStateToProps$6, mapDispatchToProps$6);
...
var HexInput = store$7(HexComponent);
