...
function (_Component) {
  ...
  _createClass(PickerArea, [{
    ...
    value: function mouseDownEvent(e) {
      ...
      var pickerAreaOffsetY = currentElement.scrollTop - boundingbox.top; // let pickerAreaOffsetX = 0;
...
})(["overflow-y:auto;display:flex;flex-direction:column;box-shadow:0 2px 4px rgba(136,158,176,0.4);background-color:#ffffff;padding:12px;border-radius:4px;width:fit-content;max-width:280px;"]);
var Container2 = styled.div.withConfig({
  displayName: "styles__Container2",
  componentId: "fzehsu-1"
})(["overflow-y:hidden;position:absolute;"]);
var BlockDivs = styled.div.withConfig({
  displayName: "styles__BlockDivs",
  componentId: "fzehsu-2"
})(["height:100px;content:\"\";width:100px;background-color:#61dafb;"]);
  ...
  _createClass(Color, [{
    ...
    value: function render() {
      var _this$props2 = this.props,
          ...
          format = _this$props2.format;
      return React__default.createElement(Container2, null, React__default.createElement(Container, null, React__default.createElement(AreaAndSliderContainer, null, React__default.createElement(PickerArea$1, Object.assign({
        h: h
      }, {
        sl: sl
      }, {
