...
function (_Component) {
  ...
  _createClass(PickerArea, [{
    ...
    value: function updateColorWithPicker(e, pickerAreaOffsetX, pickerAreaOffsetY) {
      ...
      var xValue = e.clientX + pickerAreaOffsetX;
      if (xValue > areaWidth) xValue = areaWidth;
      if (xValue < 0) xValue = 0;
      var yValue = e.clientY + pickerAreaOffsetY;
    ...
    value: function mouseDownEvent(e) {
      ...
      var pickerAreaOffsetX = currentElement.scrollLeft - boundingBox.left;
      var pickerAreaOffsetY = currentElement.scrollTop - boundingBox.top;
...
var updateHueSliderPositionVertical = function updateHueSliderPositionVertical(value, areaHeight) {
  return {
    type: hueSliderVerticalTypes.UPDATE_HUE_POSITION_VERTICAL,
    value: value,
    areaHeight: areaHeight
  };
};
var updateColorsWithHueSliderVertical = function updateColorsWithHueSliderVertical(value) {
  return {
    type: hueSliderVerticalTypes.UPDATE_COLORS_WITH_HUE_SLIDER_VERTICAL,
    value: value
  };
};
...
function (_Component) {
  ...
  _createClass(HueSliderVertical, [{
    ...
    value: function updateHValueWithSlider(e, sliderAreaOffset) {
      ...
      var yValue = e.clientY + sliderAreaOffset;
      if (yValue > areaHeight) yValue = areaHeight;
      if (yValue < 0) yValue = 0;
    ...
    value: function mouseDownEvent(e) {
      ...
      var currentElement = e.currentTarget;
      var boundingBox = currentElement.getBoundingClientRect();
      var sliderAreaOffset = currentElement.scrollTop - boundingBox.top;
...
var updateAlphaSliderPositionVertical = function updateAlphaSliderPositionVertical(value, areaHeight) {
  return {
    type: hueSliderVerticalTypes$1.UPDATE_ALPHA_POSITION_VERTICAL,
    value: value,
    areaHeight: areaHeight
  };
};
var validateAlphaValueVerticalSlider = function validateAlphaValueVerticalSlider(value) {
  return {
    type: hueSliderVerticalTypes$1.VALIDATE_ALPHA_VALUE_VERTICAL_SLIDER,
    value: value
  };
};
...
function (_Component) {
  ...
  _createClass(AlphaSlider, [{
    ...
    value: function updateAValueWithSlider(e, sliderAreaOffset) {
      ...
      var yValue = areaHeight - (e.clientY + sliderAreaOffset);
      if (yValue > areaHeight) yValue = areaHeight;
      if (yValue < 0) yValue = 0;
...
var RGBtoHex = function RGBtoHex(r, g, b, currentHEX) {
  var hexAlpha = '';

  if (currentHEX.length === 5) {
    var alphaSection = currentHEX.slice(4, 5);
    hexAlpha = "".concat(alphaSection).concat(alphaSection);
  }

  if (currentHEX.length === 9) {
    var _alphaSection = currentHEX.slice(7, 9);

    hexAlpha = "".concat(_alphaSection);
  }
...
var _marked =
/*#__PURE__*/
regenerator.mark(validateRGBInput$1);

function validateRGBInput$1(_ref) {
  var value, min, max, currentInput, currentValue, parsedInput, parsedValue, validityCheck, currentColors, r, g, b, hex, newHSL, newHSV, newHex;
...
var rgbInputEffects = [takeEvery$1(rgbInputTypes.VALIDATE_RGB_INPUT, validateRGBInput$1)];
...
function validateHSXInput(_ref) {
  var value, min, max, format, currentInput, currentValue, parsedInput, parsedValue, validityCheck, currentColors, _currentColors, h, sl, l, newHSV, newRGB, _currentColors2, r, g, b, hex, newHex, _currentColors3, _currentColors4, _h, sv, v, newHSL, _newRGB, _currentColors5, _r, _g, _b, _hex, _newHex;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 44:
          ...
          _newHex = RGBtoHex(_r, _g, _b, _hex);
          _context.next = 49;
          return put({
            type: colorTypes.UPDATE_HEX,
            value: _newHex
...
var transformHexForAlpha = function transformHexForAlpha(hex, value) {
  var convertHEXtoFull = function convertHEXtoFull(hexValue) {
    var transformedValue = hexValue;
    if (transformedValue[0] === '#') transformedValue = transformedValue.slice(1, transformedValue.length);
    if (transformedValue.length === 3) transformedValue = transformedValue.replace(/([0-9A-F])([0-9A-F])([0-9A-F])/i, '$1$1$2$2$3$3');
    if (transformedValue.length === 4) transformedValue = transformedValue.replace(/([0-9A-F])([0-9A-F])([0-9A-F])([0-9A-F])/i, '$1$1$2$2$3$3$4$4');
    return "#".concat(transformedValue);
  };

  var hexValue = hex;
  var transformedValue = Math.round(value * 255);
  var newAlphaHex = transformedValue.toString(16).toUpperCase();
  if (transformedValue < 16) newAlphaHex = "0".concat(newAlphaHex);
...
var _marked$2 =
/*#__PURE__*/
regenerator.mark(validateAInput$1);

function validateAInput$1() {
  var currentInput, currentValue, parsedInput, parsedValue, validityCheck, hexValue;
...
var aInputEffects = [takeEvery$1(aInputTypes.VALIDATE_A_INPUT, validateAInput$1)];

var aInputEffects$1 = _toConsumableArray(aInputEffects);

var _marked$3 =
/*#__PURE__*/
regenerator.mark(validateHexInput$1);

function validateHexInput$1() {
  var inputValue, colorHexValue, valid, storeValue, FinalRed, FinalGreen, FinalBlue, hexValue, newAlpha, newRGB, newHSL, newHSV;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 5:
          ...
          if (storeValue[0] !== '#') storeValue = "#".concat(storeValue);
...
var aInputEffects$2 = [takeEvery$1(hexInputTypes.VALIDATE_HEX_INPUT, validateHexInput$1)];
...
function updateColorsWithHueSlider(_ref) {
  var value, currentColors, h, sl, l, newRGB, updatedColors, r, g, b, hex, newHex;
...
var _marked$5 =
/*#__PURE__*/
regenerator.mark(validateAlphaValueVerticalSlider$1);

function validateAlphaValueVerticalSlider$1(_ref) {
  var value, hexValue;
...
var alphaSliderVerticalEffects = [takeEvery$1(hueSliderVerticalTypes$1.VALIDATE_ALPHA_VALUE_VERTICAL_SLIDER, validateAlphaValueVerticalSlider$1)];
...
var _marked$7 =
/*#__PURE__*/
regenerator.mark(updateColorsWithHueSliderVertical$1);

function updateColorsWithHueSliderVertical$1(_ref) {
  var value, currentColors, h, sl, l, newRGB, updatedColors, r, g, b, hex, newHex;
...
var hueSliderVerticalEffects = [takeEvery$1(hueSliderVerticalTypes.UPDATE_COLORS_WITH_HUE_SLIDER_VERTICAL, updateColorsWithHueSliderVertical$1)];

var hueVerticalEffects = _toConsumableArray(hueSliderVerticalEffects);

var _marked$8 =
/*#__PURE__*/
regenerator.mark(updateColorsWithPickerArea$1);

function updateColorsWithPickerArea$1(_ref) {
  var xValue, yValue, format, currentHue, currentColors, h, sl, l, newHSV, newRGB, updatedColors, r, g, b, hex, newHex, _currentColors, _h, sv, v, newHSL, _newRGB, _updatedColors, _r, _g, _b, _hex, _newHex;
...
var pickerAreaEffects = [takeEvery$1(pickerAreaTypes.UPDATE_COLORS_WITH_PICKER_AREA, updateColorsWithPickerArea$1)];
...
var hueSliderVerticalHooksEffects = [takeEvery$1(hueSliderVerticalTypes$2.UPDATE_COLORS_WITH_HUE_SLIDER_VERTICAL_HOOKS, updateColorsWithHueSliderVerticalHooks)];
...
var hueSliderVerticalReducer = _defineProperty$1({}, hueSliderVerticalTypes.UPDATE_HUE_POSITION_VERTICAL, function (state, _ref) {
  var value = _ref.value,
      areaHeight = _ref.areaHeight;
...
var alphaSliderReducer$2 = _defineProperty$1({}, hueSliderVerticalTypes$1.UPDATE_ALPHA_POSITION_VERTICAL, function (state, _ref) {
  var value = _ref.value,
      areaHeight = _ref.areaHeight;
...
var hueSliderVerticalHooksReducer = _defineProperty$1({}, hueSliderVerticalTypes$2.UPDATE_HUE_POSITION_VERTICAL_HOOKS, function (state, _ref) {
  var value = _ref.value,
      areaHeight = _ref.areaHeight;
  var newPosition = value * areaHeight / 359 | 0;
  return _objectSpread$1({}, state, {
...
function configureStore() {
  ...
  var store = createStore(rootReducer, initialState, applyMiddleware(sagaMiddleware));
  sagaMiddleware.run(_callee);
  return store;
}

/* eslint-disable global-require */
var storeEnv = configureStore;
...
function (_Component) {
  ...
  function App(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(App).call(this, props)); // https://redux.js.org/recipes/isolating-redux-sub-apps

    _this.store = storeEnv();
    return _this;
  }
