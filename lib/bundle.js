...
function validateAInput$1() {
  var currentInput, currentValue, parsedInput, parsedValue, validityCheck, hexValue, transformedValue, newAlphaHex;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 12:
          ...
          transformedValue = Math.round(parsedInput * 255);
          newAlphaHex = transformedValue.toString(16).toUpperCase();
...
function validateAlphaValueVerticalSlider$1(_ref) {
  var value, hexValue, transformedValue, newAlphaHex;
  return regenerator.wrap(function validateAlphaValueVerticalSlider$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 3:
          hexValue = _context.sent;
          transformedValue = Math.round(value * 255);
          newAlphaHex = transformedValue.toString(16).toUpperCase();
          if (transformedValue < 16) newAlphaHex = "0".concat(newAlphaHex);
