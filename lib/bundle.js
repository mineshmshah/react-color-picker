...
function (_Component) {
  ...
  _createClass(PickerArea, [{
    ...
    value: function mouseDownEvent(e) {
      ...
      var pickerAreaOffsetX = e.currentTarget.getBoundingClientRect().left + 1;
      var pickerAreaOffsetY = e.currentTarget.getBoundingClientRect().top + 1;
      console.log(e.currentTarget.getBoundingClientRect());
      console.log('Position X', pickerAreaOffsetX);
      console.log('Position Y', pickerAreaOffsetY);
